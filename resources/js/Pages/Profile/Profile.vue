        ...
        <div class="main_body">
            ...
            <div class="right_section">
                ...
                <div class="login_right_section">
                    ...
                    <div class="rating_div profile_rating">
                        <span class="total_rating" v-if="average_rating">{{average_rating}}</span>
                        <fieldset class="rate" v-if="rating">
                            <input type="radio" id="rating10" name="rating" value="10" disabled :checked="(rating == 5)? true: false"/><label for="rating10" title="5 stars"></label>
                            <input type="radio" id="rating9" name="rating" value="9" disabled :checked="(rating == 4.5)? true: false"/><label class="half" for="rating9" title="4 1/2 stars"></label>
                            <input type="radio" id="rating8" name="rating" value="8" disabled :checked="(rating == 4)? true: false"/><label for="rating8" title="4 stars"></label>
                            <input type="radio" id="rating7" name="rating" value="7" disabled :checked="(rating == 3.5)? true: false"/><label class="half" for="rating7" title="3 1/2 stars"></label>
                            <input type="radio" id="rating6" name="rating" value="6" disabled :checked="(rating == 3)? true: false"/><label for="rating6" title="3 stars"></label>
                            <input type="radio" id="rating5" name="rating" value="5" disabled :checked="(rating == 2.5)? true: false"/><label class="half" for="rating5" title="2 1/2 stars"></label>
                            <input type="radio" id="rating4" name="rating" value="4" disabled :checked="(rating == 2)? true: false"/><label for="rating4" title="2 stars"></label>
                            <input type="radio" id="rating3" name="rating" value="3" disabled :checked="(rating == 1.5)? true: false"/><label class="half" for="rating3" title="1 1/2 stars"></label>
                            <input type="radio" id="rating2" name="rating" value="2" disabled :checked="(rating == 1)? true: false"/><label for="rating2" title="1 star"></label>
                            <input type="radio" id="rating1" name="rating" value="1" disabled :checked="(rating == 0.5)? true: false"/><label class="half" for="rating1" title="1/2 star"></label>
                        </fieldset>
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-7 left_div">
                                ...
                                <div class="upload_img_div">
                                    <label for="upload_photo">Upload Photo
                                        <input type="file" accept="image/*"  name="upload_photo" id="upload_photo" ref="file" @change="onFileChange"  >
                                    </label>
                                    <img :src="form.image" v-if="form.image" style="width: 80px;height: 80px;border-radius: 50%;display: list-item;margin-top: 10px;" />
                                    <div v-if="!form.image">
                                        <img :src="user.profile_photo_path" v-if="user.profile_photo_path" style="width: 80px;height: 80px;border-radius: 50%;display: list-item;margin-top: 10px;" />
                                    </div>
                                    
                                </div>
                                <div class="bio_div">
                                    <h4 class="h4_tittle">Bio</h4>
                                    <textarea placeholder="Bio" v-model="form.bio">{{ profile ? profile.bio : ''}}</textarea>
                                </div>
                                <div class="bio_div">
                                    <h4 class="h4_tittle">Appointment Fee ($)</h4>
                                    <input type="text" name="fees" class="card-input-element" id="fees" v-model="form.fees">
                                </div>
                                <div class="specialization">
                                    ...
                                    <div class="specialization_card">
                                        ...
                                        <div class="box_card">
                                            <label>
                                                <input type="checkbox" name="product" class="card-input-element" value="Dentists" v-model="form.specialize">
                                                <div class="panel panel-default card-input">
                                        ...
                                        <div class="box_card">
                                            <label>
                                                <input type="checkbox" name="product" class="card-input-element" value="OBGYN" v-model="form.specialize">
                                                <div class="panel panel-default card-input">
...
<style scoped>
    ...
    <script>
        ...
        export default {
            ...
            props: ['profile', 'user', 'rating', 'average_rating'],
            data() {
                return { 
                    success: "",             
                    error: "",                
