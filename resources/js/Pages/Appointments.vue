    ...
    <div class="main_body">
         ...
         <div class="right_section">
            ...
            <div class="my_appointments_right">
               <div class="top_bar_c">
                  <h3 class="h3_tittle">My Appointments</h3>
               ...
               <div class="search_filter_div">
                  ...
                  <div class="selct_input date">
                     <input type="date" placeholder="FIlter by Date" v-model="date" @change="changeHandle($event)" format="mm-dd-yyyy">
                  </div>
               </div>
               <div  class="modal-vue">
                        ...
                        <tbody role="rowgroup" v-if="!loading">
                           <tr role="row" v-for="(doc,index) in bookings.data" :key="index">
                              ...
                              <td role="cell" class="btn_acept_rejct">
                                 <a href="#" class="btn_view_details btn_acpt" @click="chat(doc)">Chat</a> &nbsp;
                                 ...
                                 <div v-else>
                                    ...
                                    <a href="#" class="btn_view_details btn_rjct" @click="complete(doc, index)">Complete</a> &nbsp;
                                 </div>
      ...
      methods: {  
         changeHandle(e){
            ...
            this.timer = setTimeout(() => {
               console.log(this.date, "fdgdfgdfgd");
               this.getData();
            }, 800);
         },
         ...
         getData() {
            this.loading = true;
            axios.get(`/appointments-list?page=${this.page}&keyword=${this.keyword}&date=${this.date}`).then(({data}) => {                     
               this.bookings = data
               this.loading = false;
            }).catch(({ response })=>{
               this.loading = false;
         ...
         complete(data, index) {
            ...
            console.log(this.bookings.data, "sdfsdfsdf");
            axios.post('/booking-complete', { id: data.id })
              .then(response => {
                  this.success = response.data.message;
